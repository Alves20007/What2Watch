        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div class="md:col-span-1 space-y-4">
                ...
                <div class="space-y-6">
                    ...
                    <!-- Tipo -->
                    <div>
                        <h3 class="text-xs text-zinc-400 uppercase mb-1">Tipo</h3>
                        <div class="space-y-2">
                            <label class="flex items-center space-x-2 cursor-pointer group">
                    ...
                    <div>
                        <h3 class="text-xs text-zinc-400 uppercase mb-1">Classificação Etária</h3>
                        <div class="space-y-2">
                            <label class="flex items-center space-x-2 cursor-pointer group">
                ...
                <button id="searchButton" 
                        class="mt-4 w-full bg-orange-600 hover:bg-orange-700 text-white py-2 px-4 rounded-sm 
